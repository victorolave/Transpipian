 ...
 * @author Victor Olave
 */
public class TablaPreferencial extends javax.swing.JFrame {
   ...
   DefaultTableModel modelo;
    ...
    public TablaPreferencial() {
        initComponents();
        this.setTitle("Empleados Preferencial");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaPreferencial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaPreferencial().setVisible(true);
            }
        });
    }
