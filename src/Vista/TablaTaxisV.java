 ...
 * @author Victor Olave
 */
public class TablaTaxisV extends javax.swing.JFrame {
   ...
   public void Filtrado(String texto) {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(671, 630));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaTaxisV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaTaxisV().setVisible(true);
            }
        });
    }
