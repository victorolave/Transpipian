 ...
 * @author Victor Olave
 */
public class TablaBuses extends javax.swing.JFrame {
   ...
   DefaultTableModel modelo;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaBuses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaBuses().setVisible(true);
            }
        });
    }
