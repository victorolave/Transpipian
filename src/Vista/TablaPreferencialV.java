 ...
 * @author Victor Olave
 */
public class TablaPreferencialV extends javax.swing.JFrame {
   ...
   public void Filtrado(String texto) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaPreferencialV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaPreferencialV().setVisible(true);
            }
        });
    }
